  ...
  return (
    <div>
      ...
      <ArabicDiv data-aos="fade-in">
        <Description>
          Defect هي منظمة غير هادفة للربح قامت ببناء علامتها التجارية الخاصة
          لدعم قضية مهمة.
        </Description>
        <Description>
          ما بدأ كمشروع من شغف الشباب الكويتي أصبح الآن حركة تلهم وتحفز
          المراهقين على الوصول لأحلامهم. من خلال التعاون مع الشركات المحلية
          والجمع بين الناس لتكوين صداقات و علاقات اجتماعية ، أنشأت Defect
          مجتمعًا يربط بين الدعم والتقدير للثقافة والمواهب المحلية. يتم تعريف
          كلمة Defect بأنها "عيب أو نقص". نظرًا لما يعتبره الكبار "عيوبًا" في
          المجتمع ، أو الجيل الذي يُفترض أنه كسول ، فإن الجيل المهووس
          بالتكنولوجيا سوف يجتمع معًا ليُظهر للعالم ما يمكننا القيام به فكرتنا
          بسيطة و هي: عرض منتجات رواد الأعمال الشباب المحليين للشباب في هيئة
          بيئة إجتماعية وتوظيف مساهمات من العائدات لتمويل المزيد من الأحداث
          والتوسع. كل شيء للشباب!
        </Description>
      </ArabicDiv>
    </div>
  );
